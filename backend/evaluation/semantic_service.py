...
def labelling_ans(faculty_ans,faculty_rubrics,student_ans):
  ...
  # Escape curly braces in json_format_str for ChatPromptTemplate
  # This replaces every single '{' with '{{' and '}' with '}}'
  # This is crucial because ChatPromptTemplate tries to parse the content string for template variables
  ...
  # Convert faculty_rubrics (list of dicts) to a JSON string and escape its curly braces
...
def similarity_marks(student_id, question_id):
