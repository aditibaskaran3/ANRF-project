...
export default function AdminDashboard() {
  ...
  const fetchFaculty = async () => {
    try {
      const res = await fetch("https://anrf-backend.onrender.com/auth/faculty");
      if (res.ok) {
  ...
  const fetchAssessments = async () => {
    try {
      const res = await fetch("https://anrf-backend.onrender.com/assessment/admin/all");
      if (res.ok) {
        const data = await res.json();
        setAssessments(data);
      }
  ...
  const fetchSubmissions = async () => {
    try {
      const res = await fetch("https://anrf-backend.onrender.com/submission/all");
      if (res.ok) {
        const data = await res.json();
        setSubmissions(data);
      }
  ...
  const createFaculty = async () => {
    ...
    try {
      setCreating(true);
      const res = await fetch("https://anrf-backend.onrender.com/auth/register", {
        method: "POST",
  ...
  const deleteFaculty = async (email) => {
    ...
    try {
      const res = await fetch(
        `https://anrf-backend.onrender.com/auth/faculty/${encodeURIComponent(email)}`,
        { method: "DELETE" }
      );
      if (res.ok) {
